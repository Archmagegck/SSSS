...
public:
	...
	int weight(){return (a&1?1:0)+(a&2?1:0)+(a&4?1:0)+(a&8?1:0)+(a&16?1:0)+(a&32?1:0)+(a&64?1:0)+(a&128?1:0);};
...
for(i=1;i<256;i++)
{	
	Cbytefield fa,fb,fc,fd,r1,r2,r3,r4,r;
	printf("\ninput:");
	...
	r3=fc*fc+fd*fd;
	r=(r1*r1)/(r2*r3);
//	r=((fa*fc+fb*fd)*(fa*fc+fb*fd))/((fa*fa+fb*fb)*(fc*fc+fd*fd));
	printf("    cos2=%d %d %d %d",r1.value(),r2.value(),r3.value(),r.value());
